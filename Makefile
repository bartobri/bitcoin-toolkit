...
nodetest: $(OBJ)/$(MODS)/messages/version.o $(OBJ)/$(MODS)/message.o $(OBJ)/$(MODS)/node.o $(OBJ)/$(MODS)/hex.o  $(OBJ)/$(MODS)/crypto.o $(OBJ)/$(MODS)/mem.o $(OBJ)/$(MODS)/assert.o $(OBJ)/$(MODS)/except.o $(OBJ)/nodetest.o | $(BIN)
	$(CC) $(CFLAGS) -o $(BIN)/$@ $^ $(CLIBS)
