...
int main(void) {
	...
	t = txinput_from_raw(hex_str_to_uc(raw_input), strlen(raw_input) / 2, &c);
	printf("INPUT\n");
	printf("TX Hash: ");
	for (i = 0; i < 32; ++i) {
