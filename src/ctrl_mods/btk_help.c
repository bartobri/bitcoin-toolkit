...
void btk_help_privkey(void)
{
	...
	printf("\n");
	printf("   If no input option is spectified, btk will attemmpt to guess the input\n");
	...
	printf("   exactly 64 hexidecimal characters, btk assumes the -h option; (3) If the\n");
