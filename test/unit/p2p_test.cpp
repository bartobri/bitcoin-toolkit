...
const char* kPayloadHex =
    ...
    "00000000172f426974636f696e2d546f6f6c6b69743a342e312e302f0000000000";

const char* kFullHex =
    "f9beb4d976657273696f6e00000000006d0000008f7be3e5"
    "7f110100000000000000000000f1536500000000000000000000000000000000000000000000"
    "ffff7f000001208d000000000000000000000000000000000000ffff7f000001208d00000000"
    "00000000172f426974636f696e2d546f6f6c6b69743a342e312e302f0000000000";
...
int main() {
    ...
    CHECK(parsed.user_agent == "/Bitcoin-Toolkit:4.1.0/");
    ...
    CHECK(full[20] == 0x8f && full[21] == 0x7b && full[22] == 0xe3 && full[23] == 0xe5);
